    ...
    <LegalTextBox
      ...
      content={
        <>
          ...
          <p>Aqui estão alguns exemplos de situações em que podemos coletar seus Dados Pessoais nas mídias controladas pela Axpe:</p>
          <ul>
            <li>Ao se cadastrar para anunciar um imóvel ou obter informações sobre um imóvel anunciado, você fornece dados de identificação e contato, como nome e e-mail.</li>
          ...
          <p>Ao coletar Dados Pessoais de prestadores de serviços, colaboradores e candidatos, a Axpe informará a finalidade da coleta dos Dados Pessoais coletados. Aqui estão alguns exemplos de situações em que podemos coletar Dados Pessoais de prestadores de serviços, colaboradores e candidatos:</p>
          <ul>
            ...
            <li>Ao ser admitido, você fornece dados de identificação e contato, como nome, e-mail, endereço, telefone, além de dados bancários e informações sobre cônjuges e dependentes;</li>
          ...
          <h2>Como nós usamos seus Dados Pessoais?</h2>
          ...
          <ul>
            ...
            <li>Pesquisa de mercado e inteligência de mercado;</li>
          ...
          <h2>Com quem meus Dados Pessoais são compartilhados?</h2>
          ...
          <p>Se você for colaborador ou candidato a uma vaga de emprego na Axpe, seus Dados Pessoais poderão ser compartilhados nos seguintes casos:</p>
          <ul>
            <li>Com operadoras de plano de saúde e odontológico, para contratação e manutenção destes benefícios;</li>
          ...
          <h2>Meus Dados Pessoais serão transferidos para outros países?</h2>
          ...
          <h2>Por quanto tempo meus Dados Pessoais serão armazenados?</h2>
