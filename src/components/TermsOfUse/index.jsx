...
function TermsOfUse({ onDemand, active, onClose }) {
  return (
    <LegalTextBox
      ...
      content={
        <>
          <p>O acesso e utilização das mídias controladas pela Axpe Negócios Imobiliários Ltda. (“Axpe”), incluindo o website www.axpe.com.br e todos os websites e aplicativos (“mídias digitais”), são regulados pelos presentes Termos e Condições de Uso (doravante “Termos”), disponível para acesso a qualquer tempo, por meio do website www.axpe.com.br e das demais mídias controladas pela Axpe.</p>
          <p>A utilização das mídias controladas pela Axpe está sujeita às disposições da Política de Privacidade da Axpe, também disponível para acesso a qualquer tempo, por meio do endereço eletrônico [link] ("Política de Privacidade").</p>
          ...
          <p>O Usuário poderá entrar em contato com a Axpe a qualquer momento, por meio do e-mail dpo@axpe.com.br. A Axpe poderá contatar o Usuário sobre questões concernentes ao uso das mídias digitais.</p>
