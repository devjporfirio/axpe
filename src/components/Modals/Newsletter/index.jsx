...
function NewsletterModal() {
  ...
  return modalNewsletter ? (
    <Modal active={modalNewsletter} onClose={closeModal} dataType="Newsletter">
      <Texts>
        <Slider propsArrow={{ color: "white" }}>
          <Text>
            <TextWrapper>
              <h2>
                <strong>Cadastre-se</strong> para receber nossas novidades em{" "}
                <span>primeira mão.</span>
              </h2>
            </TextWrapper>
          </Text>
        </Slider>
      ...
      <Column>
        <FormContainer>
          <ColumnTitle>
            Por favor, preencha seus dados e fique por dentro do que acontece na
            Axpe.
          </ColumnTitle>
          <Iframe
            ref={refIframe}
