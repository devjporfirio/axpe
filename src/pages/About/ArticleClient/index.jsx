...
import { Container, Group } from 'pages/About/ArticleClient/styles';
    ...
    <Container id="cliente">
      <Group>
        ...
        <p>
          ...
          locatário. Todos são igualmente importantes e, por isso, defenderemos
          o interesse de ambos, de forma justa e sem puxar a brasa para a
          sardinha de ninguém.
        </p>
      </Group>
    </Container>
